...
char auth[] = "Google_Assistant_API";
...
#define servoPin 2 // pin 2 Servo
#define ledPin 4   // pin 4 ledPin
...
void ledcAnalogWrite(uint8_t channel, uint32_t value, uint32_t valueMax = 360)
{
